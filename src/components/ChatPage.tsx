...
import { generateAIResponse } from '../app/services/ai';
import { characterDetails as characterList } from '../app/data/characters';
...
export default function ChatPage({ character }: ChatPageProps) {
   ...
   const currentMessages = getMessages(character.id);
               ...
               <div className='flex flex-col items-center space-y-4'>
                  {characterList.map((char) => (
                     <div
                        ...
                        onClick={() =>
                           !char.locked && router.push(`/chat/${char.id}`)
                        }
                     >
                        <div className='relative w-12 h-12 rounded-full overflow-hidden'>
                           <Image
                              ...
                              className={`w-full h-full object-cover ${
                                 char.locked ? 'blur-sm brightness-75' : ''
                              }`}
                           />
                           {char.locked && (
         ...
         <div className='flex-1 flex flex-col'>
            ...
            <div className='h-16 border-b border-gray-800 flex items-center justify-between px-4'>
               <div className='flex items-center space-x-3'>
                  ...
                  <Image
                     src={`/avatars/${character.imageId}.webp`}
                     alt={character.name}
                     width={40}
                     height={40}
         ...
         <div className='hidden lg:block w-96 bg-[#111111] border-gray-800 border-l p-6'>
            ...
            <div className='mt-4'>
               ...
               <p className='mt-2 text-gray-400'>
                  {character.description.includes('http') ? (
                     <>
                        {character.description.split('http')[0]}
                        <a
                           href={
                              'http' + character.description.split('http')[1]
                           }
                           target='_blank'
